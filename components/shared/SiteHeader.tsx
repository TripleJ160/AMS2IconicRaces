      ...
      <div className="bg-black/40 backdrop-blur-md px-6 md:px-8 py-4 md:py-6 border-b border-red-900/30">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Site title */}
            <div>
              <h1 className="font-display text-xl md:text-2xl lg:text-3xl tracking-wider uppercase text-white drop-shadow-2xl">
                AMS2 Iconic Races
              </h1>
              <p className="text-xs md:text-sm text-text-secondary uppercase tracking-wide">
